...
#define		ADR_PLAYLIST			0x08
#define		ADR_MTSNAME				0x0C
...
bool		readRplsFileProgInfo(int32_t, BdavDiskInfo *, ProgInfo*, const CopyParams*);
bool		rplsMakerCheck(const uint8_t *, const int32_t);
void		readRplsProgInfo(const uint8_t *, ProgInfo *, const CopyParams *);
